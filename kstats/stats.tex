...
\definecolor{담청색}{cmyk}{.05,0,0,0}	%담청색 (hellblau):  Abkürzung für \rowcolor[cmyk]{.05,0,0,0}
\definecolor{암청색}{cmyk}{.2,0,0,0}	%암청색 (dunkelblau):  Abkürzung für \rowcolor[cmyk]{.2,0,0,0}
...
\multicolumn{5}{r}{\footnotesize 단위: \%}\\\hline %
\rowcolor{암청색}
 	&						& \multicolumn{3}{>{\cellcolor{암청색}}c}{국가별}\\
\arrayrulecolor{암청색}\cline{1-2} \arrayrulecolor{blue}\cline{3-5}	
\rowcolor{암청색}
	& \raisebox{1.75ex}[0cm][0cm]{전체} 	& 미국 	& 독일	& 일본	\\\hline
\rowcolor{담청색}
\multicolumn{1}{>{\cellcolor{담청색}}l|}{한국관련 뉴스접촉 정도}	& & & & \\\hline
자주 접하고 있다 	& 35	& 39	& 15	& 51	\\\hline 
접하고 있지 않다	& 64 	& 60	& 83	& 49	\\\whline 
\rowcolor{담청색}
\multicolumn{1}{>{\cellcolor{담청색}}l|}{한국관련 직접경험}	& & & & \\\hline
...
* die einzelzellen müssen mit \cellcolor gefärbt werden, da sie mit \multicolumn eine andere Textausrichtung bekommen haben
